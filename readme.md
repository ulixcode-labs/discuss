...
在fork的git仓库里编辑dist/_workers.js源码，找到以下并修改，注意格式，比如，public后面的默认on改成off可打开邀请及关闭公开浏览贴子

```
{"sitetitle":"Discuss","dismissmessage":"第一款能在cf上运行的自建轻量联合主机社区程序,自带主机管理前端https://github.com/minlearn/discuss, 相关咨询联系tg：https://t.me/minlearn_1keydd","public":"on"}
```
